...
public class NewsController {
	...
	@ResponseBody
	public ResponseEntity<CustomMessage> submitNews(
		...
		return new ResponseEntity<CustomMessage>(new CustomMessage("Submit News Success", false), HttpStatus.OK);
	}
	...
	public ResponseEntity<CustomMessage> updateNews(
		...
		return new ResponseEntity<CustomMessage>(new CustomMessage("Update News Success", false), HttpStatus.OK);
	}
